...
<footer id="main_footer" class="pos-relative">
  <?php if(!empty($footer_desktop_image)){ ?>
    <div class="background-bg">
      <picture class="object-fit">
        ...
        <img src="<?php echo $footer_mobile_image['url']; ?>" alt="<?php echo $footer_mobile_image['alt']; ?>" title="<?php echo $footer_mobile_image['title']; ?>">
        </picture>
    </div>
  <?php } ?>
    <!-- end of pos relative -->
        ...
        <?php if (!is_page_template( 'templates/contact.php')): ?>
          <div class="footer_top flex">
            ...
            <?php if( have_rows('footer_address', 'option') ): ?>
              ...
              <?php
                ...
                <div class="footer-address footer1-of-3 <?php echo $footer_address_select_provience; ?>">
                  <?php if(!empty($footer_address_select_provience)){ ?>
                    <div class="locator"><i class="fa-sharp fa-solid fa-location-pin"></i><?php echo $footer_address_select_provience; ?>
                    </div>
                  <?php } ?>
              ...
              <?php endif; ?>
              <?php if(!empty($footer_contact_linkldn_text && $footer_contact_linkldn_link)){ ?>
                <div class="btn-full hide-in-tablet hide-in-desktop"> 
                  <a href="<?php echo $footer_contact_linkldn_link; ?>" aria-label="opens in new tab" target="_blank" class="button reverse">
                  <figure role="none" class="object-fit"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/linkedin-icon-dark.svg" alt="linkedin-icon" title="linkedin-icon"></figure>
                  <?php echo $footer_contact_linkldn_text; ?></a> 
                </div>
              <?php } ?>
            </div>
            <!-- end of footer rt --> 
  ...
  <div class="modal" style="display:none;">
    <div class="modal-content">
        <span class="close"><button title="" type="button" class="mfp-close">×</button></span>
       	<h3>our expertise</h3>
       ...
       <p>A short subhead about IP expertise for startups here. <a>IP law for startups.</a></p>
    </div>
  </div>
  <script>
    jQuery(function(e){
      //e.preventDefault();
      jQuery(".expertise-menu").on("click",function(){
          jQuery(".modal").show();
      })
