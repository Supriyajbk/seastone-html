      ...
      <?php
        ...
        <div class="logo"> 
          <?php if(!empty($header_logo)){ ?>
            <span class="logo-pos normal-logo"> <a href="<?php echo site_url(); ?>"><img src="<?php echo $header_logo['url']; ?>" alt="<?php echo $header_logo['alt']; ?>" title="<?php echo $header_logo['title']; ?>"></a> </span> 
          <?php } if(!empty($header_logo_sticky)){ ?>
            <span class="logo-pos fixed-logo"> <a href="<?php echo site_url(); ?>"><img src="<?php echo $header_logo_sticky['url']; ?>" alt="<?php echo $header_logo_sticky['alt']; ?>" title="<?php echo $header_logo_sticky['title']; ?>"></a> </span> 
          <?php } ?>
        </div>
        <?php } ?>
