...
jqr5(function() {
    if (jqr5("#load-more-people").length) {
	 //e = 1,
           var t = true,
            n = false,
            r = jqr5(window),
            i = jqr5("#load-more-people"),
            s = jqr5("#load-more-people ul"),
            o = s.attr("data-path");
        ...
        if (o === undefined) {
            o = "<?php bloginfo('stylesheet_directory'); ?>/people-ajax-load-more.php"
        }
        ...
        var u = function() {
            ...
            jqr5.ajax({
                ...
                data: {
                    ...
                    team:  s.attr("data-team"),
                    focus:  s.attr("data-focus"),
                ...
                url: o + "/people-ajax-load-more.php",
                beforeSend: function() {
