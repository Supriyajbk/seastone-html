    ...
    if (jqr5("#ajax-load-more").length) {
	 //e = 1,
       ...
       console.log(p);
        ...
        i.append('<div id="load-more" class="btn-center"><span class="loader"></span><div class="stats-more"><span class=" readmore white">' + jqr5button + "</span></div></div>");
        var u = function() {
